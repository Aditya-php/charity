...
class MyGenealogy1 extends Common_Controller 
{
	...
	*/
	public function feederStageTree($user_id=null)
	{
	   ...
	   $data['title']="WORKER TREE";
		...
		//end level2 if here!
		_adminLayout("my-genealogy-mgmt1/feeder-stage-tree",$data);	
	}//end method
	/*
	...
	*/
	public function stage1Tree($user_id=null)
	{
		...
		_adminLayout("my-genealogy-mgmt1/tree_stage1",$data);	
	}//end method
	...
	*/
	public function stage2Tree($user_id=null)
	{
		...
		_adminLayout("my-genealogy-mgmt1/tree_stage2",$data);	
	}//end method
	...
	*/
	public function stage3Tree($user_id=null)
	{
		...
		_adminLayout("my-genealogy-mgmt1/tree_stage3",$data);	
	}//end method
	/*
	...
	*/
	public function stage4Tree($user_id=null)
	{
		...
		///////3rd level data
		if(!empty($level2_info_1_left1[0]->user_id))
		{
			$level3_info_1_left1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right1[0]->user_id))
		{
			$level3_info_1_left2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_left2[0]->user_id))
		{
			$level3_info_1_left3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right2[0]->user_id))
		{
			$level3_info_1_left4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage4 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
	   ...
	   $data['title']="ASSISTANT DIRECTOR Stage Tree";
		...
		//////Level3 data
		if(!empty($level3_info_1_left1[0]))
		{
			$data['level3_username1']=$level3_info_1_left1[0]->username;
			$data['level3_user_id1']=$level3_info_1_left1[0]->user_id;
		}
		if(!empty($level3_info_1_right1[0]))
		{
			$data['level3_username2']=$level3_info_1_right1[0]->username;
			$data['level3_user_id2']=$level3_info_1_right1[0]->user_id;
		}
		if(!empty($level3_info_1_left2[0]))
		{
			$data['level3_username3']=$level3_info_1_left2[0]->username;
			$data['level3_user_id3']=$level3_info_1_left2[0]->user_id;
		}
		if(!empty($level3_info_1_right2[0]))
		{
			$data['level3_username4']=$level3_info_1_right2[0]->username;
			$data['level3_user_id4']=$level3_info_1_right2[0]->user_id;
		}
		if(!empty($level3_info_1_left3[0]))
		{
			$data['level3_username5']=$level3_info_1_left3[0]->username;
			$data['level3_user_id5']=$level3_info_1_left3[0]->user_id;
		}
		if(!empty($level3_info_1_right3[0]))
		{
			$data['level3_username6']=$level3_info_1_right3[0]->username;
			$data['level3_user_id6']=$level3_info_1_right3[0]->user_id;
		}
		if(!empty($level3_info_1_left4[0]))
		{
			$data['level3_username7']=$level3_info_1_left4[0]->username;
			$data['level3_user_id7']=$level3_info_1_left4[0]->user_id;
		}
		if(!empty($level3_info_1_right4[0]))
		{
			$data['level3_username8']=$level3_info_1_right4[0]->username;
			$data['level3_user_id8']=$level3_info_1_right4[0]->user_id;
		}
		_adminLayout("my-genealogy-mgmt1/tree_stage4",$data);	
	}//end method
	/*
	...
	*/
	public function stage5Tree($user_id=null)
	{
		...
		if(!empty($level2_info_1_left1[0]->user_id))
		{
			$level3_info_1_left1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right1[0]->user_id))
		{
			$level3_info_1_left2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_left2[0]->user_id))
		{
			$level3_info_1_left3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right2[0]->user_id))
		{
			$level3_info_1_left4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage5 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
		...
		_adminLayout("my-genealogy-mgmt1/tree_stage5",$data);	
	}//end method
	/*
	...
	*/
	public function stage6Tree($user_id=null)
	{
		...
		if(!empty($level2_info_1_left1[0]->user_id))
		{
			$level3_info_1_left1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right1[0]->user_id))
		{
			$level3_info_1_left2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_left2[0]->user_id))
		{
			$level3_info_1_left3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right2[0]->user_id))
		{
			$level3_info_1_left4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage6 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
		...
		_adminLayout("my-genealogy-mgmt1/tree_stage6",$data);	
	}//end method
	...
	*/
	public function stage7Tree($user_id=null)
	{
		...
		if(!empty($level2_info_1_left1[0]->user_id))
		{
			$level3_info_1_left1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right1=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right1[0]->user_id))
		{
			$level3_info_1_left2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right2=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right1[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_left2[0]->user_id))
		{
			$level3_info_1_left3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right3=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_left2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
			
		}
		if(!empty($level2_info_1_right2[0]->user_id))
		{
			$level3_info_1_left4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'left','level'=>'1'))->get()->result();
			
			$level3_info_1_right4=$this->db->select(array('u.username','u.user_id'))->from('matrix_stage7 as m')->join('user_registration as u','u.user_id=m.down_id')->where(array('income_id'=>$level2_info_1_right2[0]->user_id,'m.nom_leg_position'=>'right','level'=>'1'))->get()->result();
		...
		_adminLayout("my-genealogy-mgmt1/tree_stage7",$data);	
	}//end method
}//end class
