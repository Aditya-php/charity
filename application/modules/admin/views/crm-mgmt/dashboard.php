            ...
            <div class="panel panel-body bg-danger-400 has-bg-image">
               <div class="media no-margin">
                  <div class="media-body">
                     <h3 class="no-margin">500</h3>
                     <span class="text-uppercase text-size-mini">All Leads</span>
                  </div>
            ...
            <div class="panel panel-body bg-warning-400 has-bg-image">
               <div class="media no-margin">
                  ...
                  <div class="media-body text-right">
                     ...
                     <span class="text-uppercase text-size-mini">Converted Leads</span>
                  </div>
               </div>
            </div>
         </div>
         <div class="col-sm-6 col-md-4">
            <div class="panel panel-body bg-pink-400 has-bg-image">
               <div class="media no-margin">
                  ...
                  <div class="media-body text-right">
                     <h3 class="no-margin">700</h3>
                     <span class="text-uppercase text-size-mini">Pending Leads</span>
                  </div>
               </div>
            </div>
         </div>
