                                    ...
                                    <li>
                                       <a
                                          <?php if(!empty($level1_user_id1))
                                             {
                                             ?>
                                          href="<?php echo site_url();?>admin/MyGenealogy1/stage1Tree/<?php echo ID_encode($level1_user_id1);?>">
                                          ...
                                          <li>
                                             <a
                                                <?php if(!empty($level2_user_id1))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage1Tree/<?php echo ID_encode($level2_user_id1);?>">
                                          ...
                                          <li>
                                             <a
                                                <?php if(!empty($level2_user_id2))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage1Tree/<?php echo ID_encode($level2_user_id2);?>">
                                    ...
                                    <li>
                                       <a
                                          <?php if(!empty($level1_user_id2))
                                             {
                                             ?>
                                          href="<?php echo site_url();?>admin/MyGenealogy1/stage1Tree/<?php echo ID_encode($level1_user_id2);?>">
                                          ...
                                          <li>
                                             <a
                                                <?php if(!empty($level2_user_id3))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage1Tree/<?php echo ID_encode($level2_user_id3);?>">
                                          ...
                                          <li>
                                             <a
                                                <?php if(!empty($level2_user_id4))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage1Tree/<?php echo ID_encode($level2_user_id4);?>">
