   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Stage Wise Member List</span> - Assistant Director Stage Member</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Assistant Director Stage Member</li>
         </ul>
      ...
      <div class="row">
         <div class="panel panel-flat">
            ...
            <div class="panel-heading">
               ...
               <h5 class="panel-title">Assistant Director Stage Member</h5>
	   ...
	   <div class="row">
         <div class="col-md-6">
            <div class="panel bg-primary">
               <div class="panel-heading">
                  <h6 class="panel-title">Total Member in Assistant Director Stage</h6>
               </div>
...
$(document).ready(function() {
    $('#example').DataTable( {
        ...
        "processing": true,
        "serverSide": true,
        "ajax":"<?php echo site_url();?>admin/stage_wise_member/stage4_member_list_ajax",
