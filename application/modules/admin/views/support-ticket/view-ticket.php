    ...
    <div class="content">
        ...
        <div class="row">
            <div class="panel panel-flat">
				...
				<strong>Subject:- </strong><?php echo $fetch_data['subject']; ?>
				</div>
				
				<div style="padding-left:20px;">
				<strong>Description:- </strong> <?php echo $fetch_data['description']; ?> 
				</div>
				<br>
                            ...
                            <td colspan="2">
                                ...
                                ?> 
                                    ...
                                    $field_attr = array(
                                        ...
                                        'class' => 'form-control',
                                        'id' => 'ticket_listing',
                                        'value' => site_url().'admin/SupportTicket/closedTicket'
                                    );
