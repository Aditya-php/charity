                                 ...
                                 <div class="row">
                                    <section class="col col-6">
                                       ...
                                       <label class="control-label" for="ms-form-user">Username</label>
										 <input type="text" required="" placeholder="Please enter your username" name="username" id="usernamee" class="form-control"> 
								 ...
								 <div class="row">
                                    <section class="col col-6">
                                       <label class="input">
										 ...
										 <input required="" type="password" placeholder="Please enter your password" name="password" id="passwordd" class="form-control">
								  ...
								  <section class="col col-6">   
								  <label class="input">						
								  <a href='<?php echo site_url();?>front/forgot' />Forgot Password?</a>                                        </label>                    
								  </section>      
								  </div>
                              </fieldset>
							  <footer>
