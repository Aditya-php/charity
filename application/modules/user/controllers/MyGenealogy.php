...
class MyGenealogy extends Common_Controller 
{
	...
	*/
	public function feederStageTree($user_id=null)
	{
	    ...
	    $data['title']="BUILDER TREE";
	    $data['breadcrumb']='<li class="active">BUILDER TREE</li>';
		/////
	...
	*/
	public function stage1Tree($user_id=null)
	{
	    ...
	    $data['breadcrumb']='<li class="active">SAPPHIRE TREE</li>';
		/////
		$data['main_user_id']=$user_id;
		$data['main_username']=$main_user->username;
	    ///level 1 data
	...
	*/
	public function stage2Tree($user_id=null)
	{
	    ...
	    $data['breadcrumb']='<li class="active">RUBY TREE</li>';
		/////
		$data['main_user_id']=$user_id;
		$data['main_username']=$main_user->username;
	     ///level 1 data
	...
	*/
	public function stage3Tree($user_id=null)
	{
	    ...
	    $data['breadcrumb']='<li class="active">EMERALD TREE</li>';
		/////
		$data['main_user_id']=$user_id;
		$data['main_username']=$main_user->username;
	    ///level 1 data
	...
	*/
	public function stage4Tree($user_id=null)
	{
		...
		/////////////////////////
	    $data['title']="DIAMOND TREE";
	    $data['breadcrumb']='<li class="active">DIAMOND TREE</li>';
		/////
		$data['main_user_id']=$user_id;
		$data['main_username']=$main_user->username;
	    ///level 1 data
	...
	*/
	public function stage6Tree($user_id=null)
	{
	    ...
	    $data['breadcrumb']='<li class="active">AMBASSADOR TREE</li>';
		/////
		$data['main_user_id']=$user_id;
		$data['main_username']=$main_user->username;
	    ///level 1 data
	...
	public function stage7Tree($user_id=null)
	{
	    ...
	    $data['title']="CROWN AMBASAADOR TREE";
	    $data['breadcrumb']='<li class="active">CROWN AMBASAADOR TREE</li>';
		/////
		$data['main_user_id']=$user_id;
		$data['main_username']=$main_user->username;
	    ///level 1 data
