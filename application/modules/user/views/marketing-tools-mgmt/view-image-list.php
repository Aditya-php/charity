   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Marketing Tools</span> - Image List</h4>
         </div>
   ...
   <div class="content">
      ...
      <div class="panel panel-white">
         <div class="panel-heading">
            <h6 class="panel-title text-semibold">Image List</h6>
         ...
         <table class="table table-striped media-library table-lg">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><?php echo $sno;?></td>
                  <td>
                     <a href="<?php echo base_url();?>images/<?php echo $image->image_path;?>" data-popup="lightbox">
                     <img src="<?php echo base_url();?>images/<?php echo $image->image_path;?>" alt="" class="img-rounded img-preview">
                     </a>
                  </td>
                     ...
                     <ul class="icons-list">
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right">
                              ...
                              {
                              ?>
                              <li><a title="click to Publish" href="<?php echo site_url();?>admin/MarketingTools/changeStatus/<?php echo ID_encode($image->id);?>/1"><i class="icon-eye"></i> Publish</a></li>
                              <?php    
                              }
                              else 
                              {
                              ?>
                              <li><a title="click to Unpublish" href="<?php echo site_url();?>admin/MarketingTools/changeStatus/<?php echo ID_encode($image->id);?>/0"><i class="icon-eye-blocked"></i> Unpublished</a></li>
                              <?php    
                              }
                              ?>
                              <li><a href="<?php echo site_url();?>admin/MarketingTools/deleteImage/<?php echo ID_encode($image->id);?>"><i class="icon-bin"></i> Delete</a></li>
                           </ul>
                        </li>
                     </ul>
                  </td>
