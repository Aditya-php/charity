   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Message</span> - Inbox</h4>
         </div>
                  ...
                  ?>
	                  <tr>
						 ...
						 <td>
                           ...
                           {
                           ?>
                           <a href="<?php echo site_url();?>images/<?php echo $msg->attachment;?>" target="_blank">View Attachment</a>
                           <?php    
                           } 
                           else 
                           {
	                     ...
	                     <td>
	                        <ul class="icons-list">
	                           ...
	                           <li>
	                              <a onclick="return deleteConfirm();" href="<?php echo site_url();?>user/MessagePanel/deleteInboxMessage/<?php echo ID_encode($msg->id);?>" data-popup="tooltip" title="" data-original-title="Close Ticket"><i class="icon-trash"></i></a>
	                           </li>
	                        </ul>
	                     </td>
	                  </tr>
...
$(document).ready(function(){
  $(".read_msg").click(function(){
     ...
     //alert(msg_id);
     $.ajax({
                   url: "<?php echo site_url();?>user/MessagePanel/readMessage/", // Url to which the request is send
                   type: "POST", // Type of request to be send, called as method
                   data: {'msg_id':msg_id}, 
                   beforeSend: function () {
                       $.loader("on", '<?php echo site_url();?>/images/default.svg');
                   }, 
                   ...
                   complete: function () {
                       $.loader("off", '<?php echo site_url();?>/images/default.svg');
                   }
               });//end $.ajax
